...
public class attributeNames {
    ...
    // Empty Constructors
    public attributeNames(String s){
    }

    // Constructors
    public attributeNames(String email, String firstName, String lastName, String gender, String address, String country, String IDPassport, String DOB, String phoneNumber, String password, String rePassword) {
        this.email = email;
